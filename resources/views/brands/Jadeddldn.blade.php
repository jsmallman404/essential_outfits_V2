...
<head>
  ...
  <title>Jadedldn Collection</title>
...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Jadedldn banner.jfif') }}" alt="Jadedldn Banner">
    </div>
    <div class="slideshow-content">
      <h1>Jadedldn Collection</h1>
      <p>London's finest streetwear essentials.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Jadedldn man.jpg') }}" alt="Jadedldn for Men">
      <div class="product-info">
        <h2>Jadedldn for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Jadedldn woman.jpg') }}" alt="Jadedldn for Women">
      <div class="product-info">
        <h2>Jadedldn for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Jadedldn.jpg') }}" alt="All Jadedldn">
      <div class="product-info">
        <h2>All Jadedldn</h2>
        <button>View Products</button>
      </div>
