...
<head>
  ...
  <title>Glogang Worldwide Collection</title>
...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Glogangworldwide banner.webp') }}" alt="Glogang Worldwide Banner">
    </div>
    <div class="slideshow-content">
      <h1>Glogang Worldwide Collection</h1>
      <p>Experience global streetwear culture.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Glogangworldwide man.jpg') }}" alt="Glogang Worldwide for Men">
      <div class="product-info">
        <h2>Glogang Worldwide for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Glogangworldwide woman.jpg') }}" alt="Glogang Worldwide for Women">
      <div class="product-info">
        <h2>Glogang Worldwide for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Glogangworldwide.jpg') }}" alt="All Glogang Worldwide">
      <div class="product-info">
        <h2>All Glogang Worldwide</h2>
        <button>View Products</button>
      </div>
    </div>
  </main>
