...
<nav class="nav-buttons">
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/adidas banner.webp') }}" alt="Adidas Banner">
    </div>
    <div class="slideshow-content">
      <h1>Adidas Collection</h1>
      <p>Explore the latest in sportswear.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/adidas man.webp') }}" alt="Adidas for Men">
    ...
    <div class="product-card">
      <img src="{{ asset('images/adidas woman.webp') }}" alt="Adidas for Women">
      <div class="product-info">
    ...
    <div class="product-card">
      <img src="{{ asset('images/All adidas.webp') }}" alt="All Adidas">
      <div class="product-info">
        <h2>All Adidas</h2>
        <button>View Products</button>
      </div>
