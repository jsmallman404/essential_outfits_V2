...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Osbatt banner.png') }}" alt="Osbatt Banner">
    </div>
    <div class="slideshow-content">
      <h1>Osbatt Collection</h1>
      <p>Discover the latest Osbatt designs.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Osbatt man.jpg') }}" alt="Osbatt for Men">
      <div class="product-info">
        <h2>Osbatt for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Osbatt woman.jpeg') }}" alt="Osbatt for Women">
      <div class="product-info">
        <h2>Osbatt for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Osbatt.webp') }}" alt="All Osbatt">
      <div class="product-info">
        <h2>All Osbatt</h2>
        <button>View Products</button>
      </div>
