...
<head>
  ...
  <title>Glofwang Collection</title>
...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Glofwang banner.webp') }}" alt="Glofwang Banner">
    </div>
    <div class="slideshow-content">
      <h1>Glofwang Collection</h1>
      <p>Discover unique streetwear designs.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Glofwang man.jpg') }}" alt="Glofwang for Men">
      <div class="product-info">
        <h2>Glofwang for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Glofwang woman.avif') }}" alt="Glofwang for Women">
      <div class="product-info">
        <h2>Glofwang for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Glofwang.jpg') }}" alt="All Glofwang">
      <div class="product-info">
        <h2>All Glofwang</h2>
        <button>View Products</button>
      </div>
