...
<head>
  ...
  <title>9inedouble0we Collection</title>
...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/9inedouble0we banner.jfif') }}" alt="9inedouble0we Banner">
    </div>
    <div class="slideshow-content">
      <h1>9inedouble0we Collection</h1>
      <p>Explore the latest streetwear designs.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/9inedouble0we man.webp') }}" alt="9inedouble0we for Men">
      <div class="product-info">
        <h2>9inedouble0we for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/9inedouble0we woman.webp') }}" alt="9inedouble0we for Women">
      <div class="product-info">
        <h2>9inedouble0we for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All 9inedouble0we.webp') }}" alt="All 9inedouble0we">
      <div class="product-info">
        <h2>All 9inedouble0we</h2>
        <button>View Products</button>
      </div>
    </div>
  </main>
