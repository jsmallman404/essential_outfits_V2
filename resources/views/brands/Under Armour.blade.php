...
<head>
  ...
  <title>Under Armour Collection</title>
...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Under Armour banner.webp') }}" alt="Under Armour Banner">
    </div>
    <div class="slideshow-content">
      <h1>Under Armour Collection</h1>
      <p>Gear up with Under Armour.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Under Armour man.webp') }}" alt="Under Armour for Men">
      <div class="product-info">
        <h2>Under Armour for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Under Armour woman.webp') }}" alt="Under Armour for Women">
      <div class="product-info">
        <h2>Under Armour for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Under Armor.webp') }}" alt="All Under Armour">
      <div class="product-info">
        <h2>All Under Armour</h2>
        <button>View Products</button>
      </div>
    </div>
  </main>
