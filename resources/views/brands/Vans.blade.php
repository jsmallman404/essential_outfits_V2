...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index: -1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Vans banner.webp') }}" alt="Vans Banner">
    </div>
    <div class="slideshow-content">
      <h1>Vans Collection</h1>
      <p>Discover the classic Vans style.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Vans man.webp') }}" alt="Vans for Men">
    ...
    <div class="product-card">
      <img src="{{ asset('images/Vans woman.webp') }}" alt="Vans for Women">
      <div class="product-info">
        <h2>Vans for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/vans kid.webp') }}" alt="All Vans">
      <div class="product-info">
        <h2>All Vans</h2>
        <button>View Products</button>
      </div>
