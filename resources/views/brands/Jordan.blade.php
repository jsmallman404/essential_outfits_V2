...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index:-1">
    <div class="slideshow-images">
      <img src="{{ asset('images/Jordan banner.webp') }}" alt="Jordan Banner">
    </div>
    <div class="slideshow-content">
      <h1>Jordan Collection</h1>
      <p>Step into greatness with Jordan.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Jordan man.webp') }}" alt="Jordan for Men">
      <div class="product-info">
        <h2>Jordan for Men</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/Jordan woman.webp') }}" alt="Jordan for Women">
      <div class="product-info">
        <h2>Jordan for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Jordan.webp') }}" alt="All Jordan">
      <div class="product-info">
        <h2>All Jordan</h2>
        <button>View Products</button>
      </div>
