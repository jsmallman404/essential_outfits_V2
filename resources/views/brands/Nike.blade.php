...
<body>
  ...
  <div class="slideshow" style="position: relative; z-index:-1">
    <div class="slideshow-images">
      <img src="{{ asset('images/nike banner1.webp') }}" alt="Nike Banner">
    </div>
    <div class="slideshow-content">
      <h1>Nike Collection</h1>
      <p>Discover the latest Nike products.</p>
    </div>
  </div>
  ...
  <main class="product-container">
    <div class="product-card">
      <img src="{{ asset('images/Nike man.webp') }}" alt="Nike for Men">
    ...
    <div class="product-card">
      <img src="{{ asset('images/Nike woman.webp') }}" alt="Nike for Women">
      <div class="product-info">
        <h2>Nike for Women</h2>
        <button>View Products</button>
      </div>
    </div>
    <div class="product-card">
      <img src="{{ asset('images/All Nike.webp') }}" alt="All Nike">
      <div class="product-info">
        <h2>All Nike</h2>
        <button>View Products</button>
      </div>
